...
export default function SchedulePage() {
  ...
  function makePts(sc) {
    ...
    for (var i = 0; i < sc.length; i++) {
      var x = (i / (sc.length - 1)) * 400
      var y = 100 - (sc[i].balance / loanState.amount) * 100
      pts.push(x + ',' + y)
    }
    return pts.join(' ')
  }
    ...
    <div className="flex pt-16 min-h-screen">
      ...
      <main className="flex-1 px-6 lg:px-10 py-10 max-w-5xl mx-auto overflow-x-hidden">
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400">Full amortization timeline with early payment support.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-100 dark:border-slate-800">
            <h2 className="font-bold text-slate-900 dark:text-slate-100 mb-5">Add Early Payment</h2>
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Month</label>
                <input
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-100 dark:border-slate-800">
            ...
            <div className="grid grid-cols-2 gap-4 mb-5">
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl">
                <div className="text-xs font-bold text-slate-400 uppercase mb-1">Months Saved</div>
              ...
              <div className="bg-emerald-50 dark:bg-green-900/20 p-4 rounded-xl">
                <div className="text-xs font-bold text-slate-400 uppercase mb-1">Interest Saved</div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800">
          <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
            <h2 className="font-bold text-slate-900 dark:text-slate-100">Amortization Table</h2>
            ...
            <table className="w-full text-sm">
              <thead className="bg-slate-50 dark:bg-slate-800">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right text-xs font-bold text-slate-400 uppercase">Principal</th>
                  <th className="px-4 py-3 text-right text-xs font-bold text-slate-400 uppercase">Interest</th>
